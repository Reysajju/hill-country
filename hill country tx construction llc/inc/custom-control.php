...
if( class_exists( 'WP_Customize_Control' ) ) {
	class Building_Construction_Lite_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'building-construction-lite-control-switch', trailingslashit( get_template_directory_uri() ) . 'assets/js/custom-controls.js', array( 'jquery' ) );

			wp_enqueue_style( 'building-construction-lite-control-switch', trailingslashit( get_template_directory_uri() ) . 'assets/css/custom-controls.css', '', time() );
...
if( class_exists( 'WP_Customize_Control' ) ) {
	class Building_Construction_Lite_Customizer_Customcontrol_Section_Heading extends WP_Customize_Control {
